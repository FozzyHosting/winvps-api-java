...
import fozzyhosting.winvps.auth.Authentication;
import fozzyhosting.winvps.auth.HttpBasicAuth;
import fozzyhosting.winvps.auth.ApiKeyAuth;
import fozzyhosting.winvps.auth.OAuth;

public class ApiClient {

    private String basePath = "https://winvps.fozzy.com/api/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://winvps.fozzy.com/api/v2
