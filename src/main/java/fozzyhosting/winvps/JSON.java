...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(MachineEditableFields.class, new TypeSelector<MachineEditableFields>() {
            @Override
            public Class<? extends MachineEditableFields> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends MachineEditableFields>> classByDiscriminatorValue = new HashMap<>();
                    classByDiscriminatorValue.put("MachineCreateRequestBody".toUpperCase(), MachineCreateRequestBody.class);
                    classByDiscriminatorValue.put("MachineUpdateRequestBody".toUpperCase(), MachineUpdateRequestBody.class);
                    classByDiscriminatorValue.put("MachineEditableFields".toUpperCase(), MachineEditableFields.class);
                return getClassByDiscriminator(
                            classByDiscriminatorValue,
                            getDiscriminatorValue(readElement, ""));
            }
          })
          .registerPostProcessor(MachineEditableFields.class, new PostProcessor<MachineEditableFields>() {
              @Override
              public void postDeserialize(MachineEditableFields result, JsonElement src, Gson gson) {

              }

              @Override
              public void postSerialize(JsonElement result, MachineEditableFields src, Gson gson) {
                  Map<Class<? extends MachineEditableFields>, String> discriminatorValueByClass = new HashMap<>();
                      discriminatorValueByClass.put(MachineCreateRequestBody.class, "MachineCreateRequestBody");
                      discriminatorValueByClass.put(MachineUpdateRequestBody.class, "MachineUpdateRequestBody");
                      discriminatorValueByClass.put(MachineEditableFields.class, "MachineEditableFields");
          ...
          .registerTypeSelector(MachineReinstallableFields.class, new TypeSelector<MachineReinstallableFields>() {
            @Override
            public Class<? extends MachineReinstallableFields> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends MachineReinstallableFields>> classByDiscriminatorValue = new HashMap<>();
                    classByDiscriminatorValue.put("MachineReinstallRequestBody".toUpperCase(), MachineReinstallRequestBody.class);
                    classByDiscriminatorValue.put("MachineReinstallableFields".toUpperCase(), MachineReinstallableFields.class);
                return getClassByDiscriminator(
                            classByDiscriminatorValue,
                            getDiscriminatorValue(readElement, ""));
            }
          })
          .registerPostProcessor(MachineReinstallableFields.class, new PostProcessor<MachineReinstallableFields>() {
              @Override
              public void postDeserialize(MachineReinstallableFields result, JsonElement src, Gson gson) {

              }

              @Override
              public void postSerialize(JsonElement result, MachineReinstallableFields src, Gson gson) {
                  Map<Class<? extends MachineReinstallableFields>, String> discriminatorValueByClass = new HashMap<>();
                      discriminatorValueByClass.put(MachineReinstallRequestBody.class, "MachineReinstallRequestBody");
                      discriminatorValueByClass.put(MachineReinstallableFields.class, "MachineReinstallableFields");
                  if(result instanceof JsonObject)
                  {
                      if(!((JsonObject) result).has(""))
                      {
