...
import fozzyhosting.winvps.model.BrandsListResponse;
...
public class BrandsApi {
     ...
     */
    public com.squareup.okhttp.Call brandsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call brandsGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = brandsGetCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public BrandsListResponse brandsGet() throws ApiException {
        ApiResponse<BrandsListResponse> resp = brandsGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * Returns list of all available preinstalled software set.
     * 
     * @return ApiResponse&lt;BrandsListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BrandsListResponse> brandsGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = brandsGetValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<BrandsListResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Returns list of all available preinstalled software set. (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call brandsGetAsync(final ApiCallback<BrandsListResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = brandsGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BrandsListResponse>(){}.getType();
