...
import fozzyhosting.winvps.model.LocationsListResponse;
...
public class LocationsApi {
     ...
     */
    public com.squareup.okhttp.Call locationsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call locationsGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = locationsGetCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public LocationsListResponse locationsGet() throws ApiException {
        ApiResponse<LocationsListResponse> resp = locationsGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * Returns list of locations available for new machines.
     * 
     * @return ApiResponse&lt;LocationsListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LocationsListResponse> locationsGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = locationsGetValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<LocationsListResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Returns list of locations available for new machines. (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call locationsGetAsync(final ApiCallback<LocationsListResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = locationsGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LocationsListResponse>(){}.getType();
