...
import fozzyhosting.winvps.model.ProductsListResponse;
...
public class ProductsApi {
     ...
     */
    public ProductsListResponse productsGet() throws ApiException {
        ApiResponse<ProductsListResponse> resp = productsGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ProductsListResponse> productsGetWithHttpInfo() throws ApiException {
    ...
    /**
     * Returns list of all available products. (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call productsGetAsync(final ApiCallback<ProductsListResponse> callback) throws ApiException {
