...
import fozzyhosting.winvps.model.TemplatesListResponse;
...
public class TemplatesApi {
     ...
     */
    public com.squareup.okhttp.Call templatesGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call templatesGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = templatesGetCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public TemplatesListResponse templatesGet() throws ApiException {
        ApiResponse<TemplatesListResponse> resp = templatesGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TemplatesListResponse> templatesGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = templatesGetValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<TemplatesListResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Returns list of all templates available for new machines. (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call templatesGetAsync(final ApiCallback<TemplatesListResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = templatesGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TemplatesListResponse>(){}.getType();
