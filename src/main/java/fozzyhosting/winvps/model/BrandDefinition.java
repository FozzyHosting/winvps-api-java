...
public class BrandDefinition {
        ...
        public BrandDefinition id(Integer id) {
        this.id = id;
        return this;
        }
    ...
    * @return id
    **/
        @Schema(description = "Brand primary ID. Used on machine creation")
    ...
    return id;
        ...
        public BrandDefinition name(String name) {
        this.name = name;
        return this;
        }
    ...
    **/
    ...
    return false;
        ...
        BrandDefinition brandDefinition = (BrandDefinition) o;
        return Objects.equals(this.id, brandDefinition.id) &&
        Objects.equals(this.name, brandDefinition.name);
    }
