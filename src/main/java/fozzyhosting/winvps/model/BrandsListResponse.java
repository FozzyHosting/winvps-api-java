...
import fozzyhosting.winvps.model.BrandsList;
...
public class BrandsListResponse {
        @SerializedName("data")
        private BrandsList data = null;

        @SerializedName("pagination")
        private PaginationDetails pagination = null;

        public BrandsListResponse data(BrandsList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public BrandsList getData() {
    return data;
    }

        public void setData(BrandsList data) {
        this.data = data;
        }

        public BrandsListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        BrandsListResponse brandsListResponse = (BrandsListResponse) o;
        return Objects.equals(this.data, brandsListResponse.data) &&
        Objects.equals(this.pagination, brandsListResponse.pagination);
    }
