...
public class IpDefinition {
        ...
        public IpDefinition version(Integer version) {
    ...
    * @return version
    **/
        @Schema(description = "IP version. 4 or 6")
    ...
    return version;
        ...
        public IpDefinition address(String address) {
    ...
    **/
    ...
    return false;
        ...
        IpDefinition ipDefinition = (IpDefinition) o;
        return Objects.equals(this.version, ipDefinition.version) &&
        Objects.equals(this.address, ipDefinition.address);
    }
