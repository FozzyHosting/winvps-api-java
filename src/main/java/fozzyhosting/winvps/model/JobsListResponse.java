...
import fozzyhosting.winvps.model.JobsList;
...
public class JobsListResponse {
        @SerializedName("data")
        private JobsList data = null;

        @SerializedName("pagination")
        private PaginationDetails pagination = null;

        public JobsListResponse data(JobsList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public JobsList getData() {
    return data;
    }

        public void setData(JobsList data) {
        this.data = data;
        }

        public JobsListResponse pagination(PaginationDetails pagination) {
