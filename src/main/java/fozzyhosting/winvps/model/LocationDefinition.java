...
public class LocationDefinition {
        ...
        public LocationDefinition id(Integer id) {
        this.id = id;
        return this;
        }
    ...
    * @return id
    **/
        @Schema(description = "Location primary ID. Used on machine creation")
    ...
    * @return name
    **/
        @Schema(description = "Location name. Can includes country, city, data center name, etc.")
