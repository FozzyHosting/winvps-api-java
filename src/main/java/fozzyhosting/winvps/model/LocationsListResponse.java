...
import fozzyhosting.winvps.model.LocationsList;
...
public class LocationsListResponse {
        @SerializedName("data")
        private LocationsList data = null;

        @SerializedName("pagination")
        private PaginationDetails pagination = null;

        public LocationsListResponse data(LocationsList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public LocationsList getData() {
    return data;
    }

        public void setData(LocationsList data) {
        this.data = data;
        }

        public LocationsListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        LocationsListResponse locationsListResponse = (LocationsListResponse) o;
        return Objects.equals(this.data, locationsListResponse.data) &&
        Objects.equals(this.pagination, locationsListResponse.pagination);
    }
