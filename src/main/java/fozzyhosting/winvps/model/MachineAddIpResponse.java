...
import fozzyhosting.winvps.model.MachineAddIpResponseData;
...
public class MachineAddIpResponse {
        ...
        public MachineAddIpResponse data(MachineAddIpResponseData data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineAddIpResponseData getData() {
    return data;
    }

        public void setData(MachineAddIpResponseData data) {
        this.data = data;
        }
    ...
    return false;
        ...
        MachineAddIpResponse machineAddIpResponse = (MachineAddIpResponse) o;
        return Objects.equals(this.data, machineAddIpResponse.data);
    }
