...
import fozzyhosting.winvps.model.JobDefinition;
...
public class MachineAddIpResponseData {
        @SerializedName("address")
        private String address = null;

        @SerializedName("jobs")
        private List<JobDefinition> jobs = null;

        public MachineAddIpResponseData address(String address) {
    ...
    **/
    ...
    return address;
        ...
        public MachineAddIpResponseData jobs(List<JobDefinition> jobs) {
        this.jobs = jobs;
        return this;
        }

            public MachineAddIpResponseData addJobsItem(JobDefinition jobsItem) {
                if (this.jobs == null) {
                this.jobs = new ArrayList<JobDefinition>();
                }
    ...
    **/
    ...
    return false;
        ...
        MachineAddIpResponseData machineAddIpResponseData = (MachineAddIpResponseData) o;
        return Objects.equals(this.address, machineAddIpResponseData.address) &&
        Objects.equals(this.jobs, machineAddIpResponseData.jobs);
    }

    @Override
    public int hashCode() {
    return Objects.hash(address, jobs);
    }
