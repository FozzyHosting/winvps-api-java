...
import fozzyhosting.winvps.model.MachineCommandResultResponseData;
...
public class MachineCommandResultResponse {
        @SerializedName("data")
        private MachineCommandResultResponseData data = null;

        public MachineCommandResultResponse data(MachineCommandResultResponseData data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineCommandResultResponseData getData() {
    return data;
    }

        public void setData(MachineCommandResultResponseData data) {
        this.data = data;
        }
    ...
    return false;
        ...
        MachineCommandResultResponse machineCommandResultResponse = (MachineCommandResultResponse) o;
        return Objects.equals(this.data, machineCommandResultResponse.data);
    }
