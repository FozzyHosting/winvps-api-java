...
public class MachineCommandResultResponseData {
        @SerializedName("jobs")
        private List<JobDefinition> jobs = null;

        public MachineCommandResultResponseData jobs(List<JobDefinition> jobs) {
        this.jobs = jobs;
        return this;
        }

            public MachineCommandResultResponseData addJobsItem(JobDefinition jobsItem) {
                if (this.jobs == null) {
    ...
    **/
    ...
    return false;
        ...
        MachineCommandResultResponseData machineCommandResultResponseData = (MachineCommandResultResponseData) o;
        return Objects.equals(this.jobs, machineCommandResultResponseData.jobs);
    }
