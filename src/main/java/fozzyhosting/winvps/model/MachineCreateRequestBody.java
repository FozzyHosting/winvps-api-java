...
public class MachineCreateRequestBody extends MachineEditableFields {
        ...
        @SerializedName("add_ipv6")
        private Integer addIpv6 = null;
    ...
    **/
    ...
    return autoStart;
        ...
        public MachineCreateRequestBody addIpv6(Integer addIpv6) {
    ...
    **/
        @Schema(description = "")
    public Integer getAddIpv6() {
    return addIpv6;
    }

        public void setAddIpv6(Integer addIpv6) {
        this.addIpv6 = addIpv6;
        }
    ...
    return false;
        ...
        Objects.equals(this.addIpv6, machineCreateRequestBody.addIpv6) &&
        super.equals(o);
    }

    @Override
    public int hashCode() {
    return Objects.hash(templateId, brandId, diskType, locationId, addDisk, addRam, addCpu, addBand, autoStart, addIpv6, super.hashCode());
    }
...
sb.append("    addIpv6: ").append(toIndentedString(addIpv6)).append("\n");
sb.append("}");
return sb.toString();
}
