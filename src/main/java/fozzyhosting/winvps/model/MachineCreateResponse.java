...
import fozzyhosting.winvps.model.MachineCreateResponseData;
...
public class MachineCreateResponse {
        @SerializedName("data")
        private MachineCreateResponseData data = null;

        public MachineCreateResponse data(MachineCreateResponseData data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineCreateResponseData getData() {
    return data;
    }

        public void setData(MachineCreateResponseData data) {
        this.data = data;
        }
    ...
    return false;
        ...
        MachineCreateResponse machineCreateResponse = (MachineCreateResponse) o;
        return Objects.equals(this.data, machineCreateResponse.data);
    }
