...
public class MachineCreateResponseData {
        @SerializedName("name")
        ...
        public MachineCreateResponseData name(String name) {
        this.name = name;
        return this;
        }
    ...
    **/
    ...
    return name;
        ...
        public MachineCreateResponseData jobs(List<JobDefinition> jobs) {
        this.jobs = jobs;
        return this;
        }

            public MachineCreateResponseData addJobsItem(JobDefinition jobsItem) {
                if (this.jobs == null) {
    ...
    **/
    ...
    return false;
        ...
        MachineCreateResponseData machineCreateResponseData = (MachineCreateResponseData) o;
        return Objects.equals(this.name, machineCreateResponseData.name) &&
        Objects.equals(this.jobs, machineCreateResponseData.jobs);
    }
