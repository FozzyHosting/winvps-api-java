...
import fozzyhosting.winvps.model.IpDefinition;
import fozzyhosting.winvps.model.MachineConfig;
import fozzyhosting.winvps.model.MachineOS;
...
public class MachineDefinition {
        ...
        @SerializedName("ips")
        private List<IpDefinition> ips = null;

        @SerializedName("os")
        private MachineOS os = null;

        @SerializedName("config")
        private MachineConfig config = null;

        public MachineDefinition name(String name) {
        this.name = name;
        return this;
        }
    ...
    * @return name
    **/
        @Schema(description = "Machine name and primary Key.")
    ...
    return name;
        ...
        public MachineDefinition status(String status) {
        this.status = status;
        return this;
        }
    ...
    * @return status
    **/
        @Schema(description = "Current machine status.")
    ...
    return status;
        ...
        public MachineDefinition notes(String notes) {
        this.notes = notes;
        return this;
        }
    ...
    * @return notes
    **/
        @Schema(description = "Machine notes.")
    ...
    return notes;
        ...
        public MachineDefinition ips(List<IpDefinition> ips) {
        this.ips = ips;
        return this;
        }

            public MachineDefinition addIpsItem(IpDefinition ipsItem) {
                if (this.ips == null) {
                this.ips = new ArrayList<IpDefinition>();
                }
    ...
    * @return ips
    **/
        @Schema(description = "List of IPs assegned to the Machine.")
    public List<IpDefinition> getIps() {
    return ips;
    }

        public void setIps(List<IpDefinition> ips) {
        this.ips = ips;
        }

        public MachineDefinition os(MachineOS os) {
        this.os = os;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineOS getOs() {
    return os;
    }

        public void setOs(MachineOS os) {
        this.os = os;
        }

        public MachineDefinition config(MachineConfig config) {
        this.config = config;
        return this;
        }
    ...
    **/
    ...
    return false;
        ...
        MachineDefinition machineDefinition = (MachineDefinition) o;
        return Objects.equals(this.name, machineDefinition.name) &&
        Objects.equals(this.status, machineDefinition.status) &&
        Objects.equals(this.notes, machineDefinition.notes) &&
        Objects.equals(this.ips, machineDefinition.ips) &&
        Objects.equals(this.os, machineDefinition.os) &&
        Objects.equals(this.config, machineDefinition.config);
    }

    @Override
    public int hashCode() {
    return Objects.hash(name, status, notes, ips, os, config);
    }
