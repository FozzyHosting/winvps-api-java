...
import fozzyhosting.winvps.model.MachineDefinition;
...
public class MachineDetailsResponse {
        @SerializedName("data")
        private MachineDefinition data = null;

        public MachineDetailsResponse data(MachineDefinition data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineDefinition getData() {
    return data;
    }

        public void setData(MachineDefinition data) {
        this.data = data;
        }
    ...
    return false;
        ...
        MachineDetailsResponse machineDetailsResponse = (MachineDetailsResponse) o;
        return Objects.equals(this.data, machineDetailsResponse.data);
    }
