...
public class MachineEditableFields {
        ...
        public MachineEditableFields password(String password) {
    ...
    * @return password
    **/
        @Schema(description = "The main machine password used for Administrator user.")
    ...
    return password;
        ...
        public MachineEditableFields productId(Integer productId) {
    ...
    * @return productId
    **/
        @Schema(description = "Primary Product ID.")
    ...
    return false;
        ...
        MachineEditableFields machineEditableFields = (MachineEditableFields) o;
        return Objects.equals(this.password, machineEditableFields.password) &&
        Objects.equals(this.productId, machineEditableFields.productId);
    }

    @Override
    public int hashCode() {
    return Objects.hash(password, productId);
    }
