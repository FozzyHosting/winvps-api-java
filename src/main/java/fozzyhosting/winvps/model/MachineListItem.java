...
public class MachineListItem {
        ...
        public MachineListItem name(String name) {
        this.name = name;
        return this;
        }
    ...
    **/
    ...
    return name;
        ...
        public MachineListItem status(String status) {
        this.status = status;
        return this;
        }
    ...
    **/
    ...
    return status;
        ...
        public MachineListItem notes(String notes) {
        this.notes = notes;
        return this;
        }
    ...
    **/
    ...
    return false;
        ...
        MachineListItem machineListItem = (MachineListItem) o;
        return Objects.equals(this.name, machineListItem.name) &&
        Objects.equals(this.status, machineListItem.status) &&
        Objects.equals(this.notes, machineListItem.notes);
    }

    @Override
    public int hashCode() {
    return Objects.hash(name, status, notes);
    }
