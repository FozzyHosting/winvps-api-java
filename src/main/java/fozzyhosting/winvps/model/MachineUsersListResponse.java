...
import fozzyhosting.winvps.model.MachineUsersList;
import fozzyhosting.winvps.model.PaginationDetails;
...
public class MachineUsersListResponse {
        ...
        private PaginationDetails pagination = null;

        public MachineUsersListResponse data(MachineUsersList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachineUsersList getData() {
    return data;
    }

        public void setData(MachineUsersList data) {
        this.data = data;
        }

        public MachineUsersListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        MachineUsersListResponse machineUsersListResponse = (MachineUsersListResponse) o;
        return Objects.equals(this.data, machineUsersListResponse.data) &&
        Objects.equals(this.pagination, machineUsersListResponse.pagination);
    }
