...
import fozzyhosting.winvps.model.MachinesList;
...
public class MachinesListResponse {
        @SerializedName("data")
        private MachinesList data = null;

        @SerializedName("pagination")
        private PaginationDetails pagination = null;

        public MachinesListResponse data(MachinesList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public MachinesList getData() {
    return data;
    }

        public void setData(MachinesList data) {
        this.data = data;
        }

        public MachinesListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        MachinesListResponse machinesListResponse = (MachinesListResponse) o;
        return Objects.equals(this.data, machinesListResponse.data) &&
        Objects.equals(this.pagination, machinesListResponse.pagination);
    }
