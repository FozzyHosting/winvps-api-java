...
import fozzyhosting.winvps.model.ProductDefinitionLimits;
...
public class ProductDefinition {
        ...
        private ProductDefinitionLimits limits = null;

        public ProductDefinition id(Integer id) {
        this.id = id;
        return this;
        }
    ...
    * @return id
    **/
        @Schema(description = "Product primary ID. Used on machine creation")
    ...
    return id;
        ...
        public ProductDefinition name(String name) {
        this.name = name;
        return this;
        }
    ...
    **/
    ...
    return name;
        ...
        public ProductDefinition limits(ProductDefinitionLimits limits) {
        this.limits = limits;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public ProductDefinitionLimits getLimits() {
    return limits;
    }

        public void setLimits(ProductDefinitionLimits limits) {
        this.limits = limits;
        }
    ...
    return false;
        ...
        return Objects.equals(this.id, productDefinition.id) &&
        Objects.equals(this.name, productDefinition.name) &&
        Objects.equals(this.limits, productDefinition.limits);
    }

    @Override
    public int hashCode() {
    return Objects.hash(id, name, limits);
    }
