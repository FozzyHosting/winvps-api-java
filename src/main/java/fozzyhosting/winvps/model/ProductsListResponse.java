...
import fozzyhosting.winvps.model.ProductsList;
...
public class ProductsListResponse {
        @SerializedName("data")
        private ProductsList data = null;

        @SerializedName("pagination")
        private PaginationDetails pagination = null;

        public ProductsListResponse data(ProductsList data) {
        this.data = data;
        return this;
        }
    ...
    **/
    ...
    return data;
        ...
        public ProductsListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        return Objects.equals(this.data, productsListResponse.data) &&
        Objects.equals(this.pagination, productsListResponse.pagination);
    }
