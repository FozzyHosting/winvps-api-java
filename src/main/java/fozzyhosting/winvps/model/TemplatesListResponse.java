...
import fozzyhosting.winvps.model.TemplatesList;
...
public class TemplatesListResponse {
        ...
        public TemplatesListResponse data(TemplatesList data) {
        this.data = data;
        return this;
        }
    ...
    **/
        @Schema(description = "")
    public TemplatesList getData() {
    return data;
    }

        public void setData(TemplatesList data) {
        this.data = data;
        }

        public TemplatesListResponse pagination(PaginationDetails pagination) {
    ...
    **/
    ...
    return false;
        ...
        return Objects.equals(this.data, templatesListResponse.data) &&
        Objects.equals(this.pagination, templatesListResponse.pagination);
    }
